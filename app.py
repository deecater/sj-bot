            ...
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    if (message_text.lower() == "help"):
                        ...
                        send_message(sender_id, "For many years, homosexual relationships were considered capital offenses in the US with laws forbidding Sodomy or Buggery. One of the first gay rights groups in the US"
